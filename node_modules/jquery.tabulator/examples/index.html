...
<head>
	...
	<link rel="stylesheet" href="../dist/css/bootstrap/tabulator_bootstrap4.css">
		...
		var printIcon = function(value, data, cell, row, options){ //plain text value
			...
			//signout
			  $(".table").tabulator({
			  	...
			  	{title: "Reg", field: "reg", width:120, sorter:"alphanum", sortable: true, bottomCalc:"count", topCalc:"count"},
			  	{title: "User", headerFilter:"input", field: "user_name", width:150, sorter:"alphanum", sortable: true, bottomCalc:"count", topCalc:"count"},
			  	{title: "Job", field: "job_link", width:200, sorter:"alphanum", sortable: true, bottomCalc:"count", topCalc:"count"},
			  	{title: "Destination", field: "destination", width:200, sorter:"alphanum", sortable: true, bottomCalc:"count", topCalc:"count"},
			  ...
			  $("#action1").click(function(){
			  	$(".tabulator").tabulator.setData("tabledata");
			  })
